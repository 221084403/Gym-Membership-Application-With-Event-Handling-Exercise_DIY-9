...
public class Member {
    ...
    public Member(String name, String surname, String idNo, String gender, 
            String contractType, Boolean isPersonalTrainerNeeded) {
        this.name = name;
    ...
    public String toString() {
        return name + "," + surname + "," + idNo + "," + gender + "," + contractType + "," + isPersonalTrainerNeeded;
    }
